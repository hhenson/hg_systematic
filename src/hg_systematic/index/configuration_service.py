...
def index_configuration(symbol: TSS[str]) -> TS[IndexConfiguration]:
    """
...
def static_index_configuration(symbol: TSS[str], indices: Mapping[str, IndexConfiguration]) -> TS[IndexConfiguration]:
    """
